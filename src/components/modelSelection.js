...
const ModelSelection = ({ models, selectedModel, onSelectModel }) => {
  return (
    <Listbox className='z-10' value={selectedModel} onChange={onSelectModel}>
      <div className='relative mt-5'>
        <Listbox.Button className='relative w-full cursor-default rounded-lg bg-white text-slate-900 py-3 pl-5 pr-10 text-left shadow-md focus:outline-none focus-visible:border-indigo-500 focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 focus-visible:ring-offset-2 focus-visible:ring-offset-orange-300 sm:text-sm'>
